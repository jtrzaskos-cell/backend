...
// Histórico simples em memória (só para testes)
let historico = [];
...
`;
    ...
    // Mantém só as últimas 50 conversas
...
// Rota para ver o histórico (só para testes)
